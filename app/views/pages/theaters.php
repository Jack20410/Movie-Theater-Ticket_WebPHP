...
<head>
    ...
    <title>Movie Theater - Our Theaters</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="upcoming.php">Coming Soon</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="theaters.php">Theaters</a>
                    </li>
                </ul>
    ...
    <div class="container mt-4">
        <h2 class="mb-4 text-white">Our Theaters</h2>
        <div class="row">
            <!-- Theater 1 -->
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="card-title text-white">Main Theater</h5>
                        <p class="card-text">
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="card-title text-white">VIP Theater</h5>
                        <p class="card-text">
                            <small class="text-muted">
                                Location: 456 Premium Avenue<br>
                                Capacity: 100 seats<br>
                                Features: Reclining seats, Premium sound
                            </small>
                        </p>
                    </div>
                </div>
